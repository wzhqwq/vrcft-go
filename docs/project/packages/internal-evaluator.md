...
## Known gaps
M5 avatar planning/binding is implemented by `internal/avatar`, and M6 Application installation plus evaluator-to-OSC composition are complete outside this package. M7 persistence/UI remains incomplete. OSC networking/lifecycle stays outside this package; numeric Lip payload and Expression-to-Lip mapping remain deferred.
