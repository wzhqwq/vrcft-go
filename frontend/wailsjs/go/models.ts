export namespace main {
	...
	export class DiagnosticEntry {
	    ...
	    static createFrom(source: any = {}) {
	        return new DiagnosticEntry(source);
	    }
	...
	export class DiagnosticsResponse {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.entries = this.convertValues(source["entries"], DiagnosticEntry);
	        this.failure = this.convertValues(source["failure"], DiagnosticEntry);
	        this.logPath = source["logPath"];
	        this.diskError = source["diskError"];
	    }
